...
export default function OrderDetailsScreen() {
    ...
    const [orderStatus, setOrderStatus] = useState(current_cart_details?.paymentStatus);
    ...
    return (
        <View style={{ backgroundColor: 'white' }}>
            <ScrollView>
                ...
                />
                <View style={styles.border2}></View>
                <ThirdScreen3 orderStatus={orderStatus} isOrder={true} currentCartData={current_cart_details} />
            </ScrollView>
        </View>
    );
}
